...
abstract class NotificationRemoteDataSource {
  Future<Either<String, NotificationModel>> getNotification(int user_id);
...
class NotificationRemoteDataSourceImpl extends NotificationRemoteDataSource {
  ...
  @override
  Future<Either<String, NotificationModel>> getNotification(int user_id) async {
    if (await networkInfo.hasConnection) {
      try {
        final re = await dio.get(
          Endpoints.Notifications+"user_id="+"$user_id",
            );
